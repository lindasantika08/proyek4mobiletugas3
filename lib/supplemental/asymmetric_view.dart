...
class AsymmetricView extends StatelessWidget {
  ...
  const AsymmetricView({Key? key, required this.photo}) : super(key: key);
  ...
  List<Widget> _buildColumns(BuildContext context) {
    ...
    return List.generate(_listItemCount(photo.length), (int index) {
      ...
      if (index % 2 == 0) {
        ...
        column = OneProductCardColumn(
          photo: photo[_oddCasesIndex(index)],
        );
      }
      return SizedBox(
        width: width,
